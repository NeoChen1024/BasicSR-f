...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="ffhq", help="Dataset name. Options: 'ffhq' | 'celeba'. Default: 'ffhq'.")
    parser.add_argument(
        "--tf_file",
        type=str,
    ...
    parser.add_argument("--save_type", type=str, default="img", help="Save type. Options: 'img' | 'lmdb'. Default: 'img'.")
    parser.add_argument("--compress_level", type=int, default=1, help="Compress level when encoding images. Default: 1.")
    ...
    if args.dataset == "ffhq":
        convert_ffhq_tfrecords(
            args.tf_file, args.log_resolution, args.save_root, save_type=args.save_type, compress_level=args.compress_level
        )
    else:

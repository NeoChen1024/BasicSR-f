...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path", type=str, default="experiments/pretrained_models/DFDNet/DFDNet_official-d1fa5650.pth"  # noqa: E251
    )
    parser.add_argument(
        "--dict_path", type=str, default="experiments/pretrained_models/DFDNet/DFDNet_dict_512-f79685f0.pth"  # noqa: E251
    )

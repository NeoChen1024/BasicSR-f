...
def main():
    ...
    parser.add_argument(
        "--task", type=str, default="classical_sr", help="classical_sr, lightweight_sr, real_sr, gray_dn, color_dn, jpeg_car"
    )
    ...
    parser.add_argument(
        "--model_path", type=str, default="experiments/pretrained_models/SwinIR/001_classicalSR_DF2K_s64w8_SwinIR-M_x4.pth"
    )
